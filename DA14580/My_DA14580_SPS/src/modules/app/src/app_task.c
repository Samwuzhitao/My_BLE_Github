                                         ...
                                         ke_task_id_t const src_id)
{
    if (ke_state_get(dest_id) == APP_DISABLED)
    {
        ...
        cmd->operation = GAPM_RESET;
				printf_string(" gapm_device_ready_ind_handler : GAPM_RESET_CMD \r\n ");
        ke_msg_send(cmd);
    }
    else
    {
...
int gapm_cmp_evt_handler(ke_msg_id_t const msgid,
                                ...
                                ke_task_id_t const src_id)
{	
	  //printf_string(" gapm_cmp_evt_handler operation : \r\n ");
        ...
        case GAPM_RESET:
        {
            ...
            else
            {
                ...
                app_configuration_func(dest_id, cmd);
								//printf_string(" gapm_cmp_evt_handler : GAPM_SET_DEV_CONFIG_CMD \r\n ");
                ke_msg_send(cmd);
            }
        }
        break;
                                      ...
                                      ke_task_id_t const src_id)
{
    ...
    ke_msg_send(cmd);
    //printf_string(" gapc_param_update_req_ind_handler : GAPC_PARAM_UPDATE_CFM \r\n");
    return (KE_MSG_CONSUMED);
}
