...
void app_init(void)
{
    ...
    ke_state_set(TASK_APP, APP_DISABLED);
		//printf_string(" ****************************************************** \r\n ");
	  //printf_string("TASK_APP ==>> APP_DISABLED *************************** \r\n ");
		//printf_string("****************************************************** \r\n ");
    #if (BLE_APP_SEC)
    app_sec_init();
    #endif // (BLE_APP_SEC)
...
{ 
    ...
    end_db_create = app_db_init_func();
	  ...
	  //printf_string(" app_db_init: db_init \r\n");
...
void app_disconnect(void)
{
    ...
    // Send the message
	  //printf_string(" app_disconnect: GAPC_DISCONNECT_CMD \r\n ");
    ke_msg_send(cmd);
}
...
void app_connect_confirm(uint8_t auth)
{
    ...
    // Send the message
		//printf_string(" app_connect_confirm: GAPC_CONNECTION_CFM \r\n ");
    ke_msg_send(cfm);
}
...
void app_adv_start(void)
{
    ...
    // Send the message
	  //printf_string(" app_adv_start : GAPM_START_ADVERTISE_CMD \r\n ");
    ke_msg_send(cmd);

    // We are now connectable
    ke_state_set(TASK_APP, APP_CONNECTABLE);
		//printf_string("****************************************************** \r\n ");
	  //printf_string("TASK_APP ==>> APP_CONNECTABLE  *********************** \r\n ");
		//printf_string("****************************************************** \r\n ");
}
...
void app_adv_stop(void)
{
    ...
    // Send the message
	  //printf_string(" app_adv_stop: GAPM_CANCEL_CMD \r\n ");
    ke_msg_send(cmd);
}
...
void app_scanning(void)
{
    ...
    // Send the message
	  //printf_string(" app_scanning: GAPM_START_SCAN_CMD \r\n ");
    ke_msg_send(msg);   
...
void app_connect(void)
{
    ...
    // Send the message
	  //printf_string(" App: GAPM_START_CONNECTION_CMD \r\n ");
    ke_msg_send(msg);    
}
...
void app_cancel_scanning(void)
{
    ...
    cmd->operation = GAPM_SCAN_PASSIVE; // Set GAPM_SCAN_PASSIVE
	  //printf_string(" App: GAPM_CANCEL_CMD \r\n ");
